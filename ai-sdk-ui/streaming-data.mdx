...
description: Learn how to stream custom data parts, sources, and metadata alongside AI responses using the UIMessageStream API.
---
...
<Note>
  ...
  Protocol](/ai-sdk-ui/stream-protocol#ui-message-stream-protocol).
</Note>
...
Both [message metadata](/ai-sdk-ui/message-metadata) and data parts allow you to send additional information alongside messages, but they serve different purposes:
...
For more details on message metadata, see the [Message Metadata documentation](/ai-sdk-ui/message-metadata).
