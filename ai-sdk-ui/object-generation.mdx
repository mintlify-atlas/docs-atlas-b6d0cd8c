---
title: Object Generation with useObject
description: Learn how to generate and stream structured JSON objects with the useObject hook for type-safe data streaming.
---
