...
description: Learn how to use server-side and client-side tools with the useChat hook, including automatic execution, user interaction, and approval workflows.
---
