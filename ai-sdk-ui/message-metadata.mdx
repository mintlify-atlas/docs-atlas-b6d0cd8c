...
description: Learn how to attach and use custom metadata with messages for tracking timestamps, model information, token usage, and more.
---
...
Message metadata differs from [data parts](/ai-sdk-ui/streaming-data) in that it's attached at the message level rather than being part of the message content. While data parts are ideal for dynamic content that forms part of the message, metadata is perfect for information about the message itself.
...
<Note>
  ...
  [data parts](/ai-sdk-ui/streaming-data) instead.
</Note>
...
- [Chatbot Guide](/ai-sdk-ui/chatbot#message-metadata) - Message metadata in the context of building chatbots
- [Streaming Data](/ai-sdk-ui/streaming-data#message-metadata-vs-data-parts) - Comparison with data parts
